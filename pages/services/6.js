					...
					<div className="row">
						<div className="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-bottom-fix">
							<div className="left-heading">
								<h2 className="section-title">Qu’analyse-t-on lors d’un audit de référencement ?</h2>
							</div>
							<div className="left-text">
								<p>
									Notre expertise en référencement organique nous a amenés à remarquer que près de 90%
									des sites Internet ont une absence d’optimisation SEO. Souvent avec des balises meta
									description ou Title absentes ou mal optimisées. Ces défauts sont d’entrée
									rédhibitoires pour indexer correctement votre site internet par l’algorithme Google.
									C’est pourquoi, pour élaborer une stratégie web et évaluer l’ampleur des actions à
									mener pour l’amélioration du positionnement de votre Site Internet dans les
									résultats des moteurs de recherche, il convient d’effectuer un audit de
									référencement afin d’élaborer le projet sur des bases saines.
								</p>
								<p>
...
export default SixthServicePage;
