		...
		<React.Fragment>
			...
			<div className="container mt-5 p-5">
				<p className="text-center" style={{ color: '#777' }}>
					Les réseaux sociaux représentent aujourd’hui le premier point de contact d’une organisation avec un
					utilisateur et un client potentiel. Au premier coup d’œil, vous devez le convaincre de la pertinence
					et de la qualité de votre contenu pour l’inciter à aller plus loin. NUN SARL crée pour vous une
					stratégie de communication précise et adaptée sur les réseaux sociaux.
				</p>
			</div>
