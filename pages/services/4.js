		...
		<React.Fragment>
			...
			<div className="container mt-5 p-5">
				<p className="text-center" style={{ color: '#777' }}>
					...
					prospects/clients/candidats. Le dispositif digital converge régulièrement vers lui afin de présenter
					l’entité et de générer des prises de contact, des ventes, des candidatures, etc.{' '}
					<strong style={{ color: '#eb444d' }}>NUN SARL</strong> a déjà accompagné de nombreuses entreprises
					dans la création de site web de marque et corporate.
				</p>
			</div>
