		...
		<React.Fragment>
			...
			<div className="container mt-5 p-5">
				<p className="text-center" style={{ color: '#777' }}>
					Que l’on veuille diffuser des messages au plus grand nombre, développer sa communauté ou même tout
					simplement l’animer et l’engager, les investissements médias sur les réseaux sociaux sont
					aujourd’hui devenus une obligation. Pour répondre à vos attentes et développer des communautés
					actives et impliquées, nous nous engageons toujours sur des résultats garantis avec comme ambition
					de toujours les dépasser !
				</p>
			</div>
